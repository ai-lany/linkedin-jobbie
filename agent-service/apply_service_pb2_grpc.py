...
import apply_service_pb2 as apply__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in apply_service_pb2_grpc.py depends on'
...
def add_ApplyServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'apply.ApplyService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('apply.ApplyService', rpc_method_handlers)
